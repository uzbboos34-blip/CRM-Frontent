...
export default function StudentGroupLessons() {
  ...
  // Selected video within the active lesson
          ...
          <Box sx={{
            ...
            {activeVideo ? (
              ...
              <Box sx={{
                ...
                {/* Simulated content structure / background details */}
                <Box sx={{
                  opacity: 0.1,
                  position: 'absolute',
                  width: '80%',
                ...
                {/* Najot Ta'lim watermark in background */}
                <Typography sx={{
                  position: 'absolute',
                ...
                {/* Big Orange/Gold Play button in the center */}
                <Box sx={{
                  width: 76,
                  height: 76,
                  borderRadius: '50%',
              ...
              <Box sx={{
                ...
                {/* Najot Ta'lim abstract logo shape */}
                <Box sx={{
                  width: 90,
                  height: 90,
                  display: 'flex',
                ...
                <>
                  ...
                  <Box>
                    ...
                    {activeLesson.homework.isOverdue ? (
                      ...
                      // Light Amber/Orange warning box (Not overdue)
                      <Box sx={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: 1.5,
                  ...
                  {activeLesson.state === 'bajarilmagan' && !isEditing ? (
                    // 1. Image 1 - Bajarilmagan submission field
                    <Box>
                    ...
                    // 2. Image 2 & 3 - Mening jo'natmalarim section
                    <Box>
                      ...
                      {/* Submitted response date footer */}
                      ...
                      {/* O'qituvchi izohi block (If accepted) */}
          ...
          {lessons.map((lesson) => {
            ...
            return (
              <Box key={lesson.id} sx={{ display: 'flex', flexDirection: 'column', gap: 0.8 }}>
                ...
                >
                  {/* Thick gold right indicator bar for active card */}
                  {isActive && (
                    <Box sx={{
                      position: 'absolute',
                      right: 0,
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', pr: isActive ? 1.5 : 0 }}>
                    ...
                    {/* Expand Chevron Icon if there are videos */}
                    {hasVideos && (
                      <IconButton
                        size="small"
