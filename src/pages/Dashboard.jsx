...
export default function Dashboard() {
  ...
  /* Completion bars (static demo – replace with real API data if available) */
  const bars = [
    { label: "O'quvchilar to'lovi", pct: 72, color: 'linear-gradient(90deg,#10b981,#059669)' },
    { label: 'Dars davomati', pct: 86, color: 'linear-gradient(90deg,#7b61ff,#6d28d9)' },
    { label: 'Vazifalar bajarilishi', pct: 61, color: 'linear-gradient(90deg,#f59e0b,#d97706)' },
    { label: "Kurs to'liqlanishi", pct: 45, color: 'linear-gradient(90deg,#0ea5e9,#0284c7)' },
  ];
  ...
  const fmtAgo = (minAgo) => {
    ...
    return `${Math.round(minAgo / 60)} soat oldin`;
  };
  const activities = [
    { dot: '#10b981', text: "Yangi o'quvchi ro'yxatga qo'shildi", time: fmtAgo(5) },
    { dot: '#7b61ff', text: "WD-25 guruhiga yangi dars qo'shildi", time: fmtAgo(18) },
    { dot: '#f59e0b', text: "Aziz Ismoilov uyga vazifa topshirdi", time: fmtAgo(35) },
    { dot: '#0ea5e9', text: "JavaScript kursi yangilandi", time: fmtAgo(72) },
    { dot: '#ef4444', text: "Bobur Sodiqov darsga kelmadi", time: fmtAgo(120) },
  ];
